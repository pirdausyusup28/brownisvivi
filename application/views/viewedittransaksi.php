    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-6">
          ...
          <hr>
          <?php echo form_open_multipart('Transaksi/uploadedit'); ?>
            <div class="form-group row">
              <label for="inputEmail3" class="col-sm-3 col-form-label">Nama Lapangan</label>
              <div class="col-sm-9">
                <input type="hidden" class="form-control" id="idtransaksi" name="idtransaksi" value="<?= $v->idtransaksi ?>" readonly>
                <input type="text" class="form-control" id="namalapangan" name="namalapangan" value="<?= $v->namalapangan ?>" readonly>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputPassword3" class="col-sm-3 col-form-label">Nama Customer</label>
              <div class="col-sm-9">
                <input type="text" class="form-control" id="namauser" name="namauser" placeholder="Nama Customer" value="<?= $v->namauser ?>">
              </div>
            </div>
            <div class="form-group row">
              <label for="inputPassword3" class="col-sm-3 col-form-label">Tanggal Booking</label>
              <div class="col-sm-9">
                <input type="hidden" class="form-control" id="statusbooking" name="statusbooking" placeholder="" value="Offline" value="<?= $v->statusbooking ?>">
                <input type="date" class="form-control" id="tanggal" name="tanggal" placeholder="" value="<?= $v->tanggal ?>">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input type="time" class="form-control" id="jam" name="jam" placeholder="" value="<?= $v->jam ?>">
