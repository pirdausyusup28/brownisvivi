                                ...
                                <tbody>
                                    <?php $no=1; foreach ($user as $v): ?>
                                        <tr>
                                            ...
                                            <td><?= $v->email ?></td>
                                            <td>
                                                <a href="<?= base_url('Admin/edituser/'); ?><?= $v->iduser; ?>" class="btn btn-warning btn-sm">Edit</a>
                                                <a href="<?= base_url('Admin/hapusdatauser/'); ?><?= $v->iduser; ?>" class="btn btn-danger btn-sm">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
